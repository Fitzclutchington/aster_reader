        ...
        if currentparent[1] == 'g':
            ...
            if newkey == 'VALUE':
                if currentparent[0] == "ADDITIONALATTRIBUTENAME":
                    ...
                    if currentdict.has_key(currentparent[0]):
                        if (type(currentdict[currentparent[0]]) == list):
                            currentdict[currentparent[0]].append(_postprocess(newval))
                        else:
                            currentdict[currentparent[0]] = [currentdict[currentparent[0]]]
                            currentdict[currentparent[0]].append(_postprocess(newval))
                    else:
